...
const defaultKeyMappings = {
  ...
  "r": "reload",
  "yy": "copyCurrentUrl",
  "p": "openVomnibarInCurrentTab",
  "P": "openVomnibarInNewTab",
  "gi": "focusInput",
  "[[": "goPrevious",
  "]]": "goNext",
  "gf": "nextFrame",
...
const commandDescriptions = {
  ...
  openVomnibarInCurrentTab: ["Open Vominibar", { noRepeat: true }],
  openVomnibarInNewTab: ["Open Vomnibar (new tab)", { repeatLimit: 20 }],
